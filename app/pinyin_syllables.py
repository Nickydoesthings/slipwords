# Valid bare pinyin syllables (no tone). Used to detect "bare pinyin" search input.
# Matches what parse_cedict stores in pinyin_bare (lowercase, ü normalized to u).
# Standard Mandarin set; extend if CEDICT introduces rare syllables.

VALID_BARE_SYLLABLES: frozenset[str] = frozenset({
    "a", "ai", "an", "ang", "ao",
    ...
    "nin", "ning", "niu", "nong", "nou", "nu", "nuan", "nue", "nuo",
    "o", "ou",
